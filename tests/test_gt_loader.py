...
class TestGroundTruthLoaderRead(unittest.TestCase):
    ...
    def test_read_ground_truth(self):
        ...
        for sequence_name, sequence_data in all_data.items():
        ...
        self.assertEqual(set(all_data.keys()), set(ground_truth.keys()))
